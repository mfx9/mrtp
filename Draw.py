...
pa = Plane (center=(0.0, 0.0, 0.0), normal=(0.0, 0.0, 1.0), scale=0.15, texture="textures/04univ2.png")
pb = Plane (center=(-12.0, 0.0, 0.0), normal=(1.0, 0.0, 0.0), scale=0.15, texture="textures/01tizeta_floor_g.png")
pc = Plane (center=(0.0, -12.0, 0.0), normal=(0.0, 1.0, 0.0), scale=0.25, texture="textures/trak_light2b.png")

ca = Cylinder (center=(0.0, 0.0, 0.0), direction=(0.0, 0.0, 1.0), radius=1.0, span=-1.0, texture="textures/qubodup-light_wood.png")
